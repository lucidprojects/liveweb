 ...
 window.addEventListener('load', function () {
     ...
     function receiveData(data) {
         ...
         function cleanArrays(rArray, lArray) {
             ...
             // also first time using the 'spead' oporator yay
 ...
 **********/
 ...
 var randomPos = function () {
     ...
     let leftMathPx = vwTOpx(leftMath);

     console.log("leftMath = " + leftMath + " leftMatPx = " + leftMathPx);

     // console.log("winWidth = " + winWidth);

     if (leftMathPx > winWidth - 400) {
         leftMath -= Math.floor(Math.random(400, 600));
         console.log("leftMath updated to " + leftMath);
     }
     ...
     for (let i = 0; i < topVals.length; i++) {
         ...
         let topMin = topVals[i] - 20;
         let topMax = topVals[i] + 20;



         // if (between(topMath, topMin, topMax)) {
         //     console.log("top of " + top + "is btwn " + topMin + " & " + topMax);
         //     topMath += 30;
         // }
         // if (between(leftMath, leftVals[i] - 20, leftVals[i] + 20)) {
         //     left += 30;
         // }
 ...
 var updateAnswerCount = (answerCounter) => {
     ...
     // console.log(answerCounter + " participants answered");
 }
 ...
 function displayTextLoop() {
     ...
     for (let i = 0; i < 15; i++) {
         ...
         // console.log(mySpan);
         // console.log('sentence' + i + ' ' + mySpanWidth);
 ...
 function displayText(i, mySpanWidth) {
     setTimeout(function () {
         ...
         // used Velocity lib instead of jquery    
         // $('#sentence' + i).animate({ width: mySpanWidth }, 2500);
         // $('#sentence' + i + ' span').css('position','absolute'); 
     }, 2500 * i);
 }
