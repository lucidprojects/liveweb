 ...
 //adjectives
 var feelings = ["tired", "hot", "hungry"];
 //nones
 var objects = ["square", "black", "plastic", "old"];
 //nones
 var loves = ["dogs", "people", "sleep", "knowledge"];
 //nones
 var tech = ["terminator", "electricity", "raspberrypi"];

 //verbs
 var verbs = ["sings", "dances", "dancing", "smile"];

 // these valuse don't get passed - preps and time are not used yere
 ...
 let haiku = () => {
     ...
     document.getElementById('progress').innerHTML = '<div id="outerHaiku"  style="' + randomPos() + '">' +
         ...
         '<div id="haiku1"><span class="haiku">' + getSyls(verbs, 2) + ' ' + getSyls(arts, 1) + " " + getSyls(loves, 2) + ' ' + getSyls(objects, 2) + '</span></div><br>' +
